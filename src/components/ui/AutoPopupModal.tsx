...
export default function AutoPopupModal() {
  ...
  // ⏰ TRIGGER: Open after 3 seconds (Every Reload)
  useEffect(() => {
  ...
  const handleWhatsApp = () => {
    const phone = "917081808180"; // Your Number
          ...
          {status === "success" ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-center scale-90 origin-center">
                <ReCAPTCHA ref={recaptchaRef} sitekey="6Lfb5EEsAAAAAKP7IhjNGBY974dUFvEvZ7-jD7yN" onChange={(token) => setCaptchaToken(token)} />
              </div>
